...
String apiKey = "K4L0OIBNQ0ELZGD7"; // Enter your Write API key from ThingSpeak
const char* ssid = "Avk's Galaxy A50s";     // replace with your wifi ssid and wpa2 key
const char* pass = "Jayakrishna1";
